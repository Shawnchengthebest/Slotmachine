...
# Simple game HTML that integrates with user system
GAME_HTML = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>🎰 Lucky Slot Machine - Game</title>
    <style>
    ...
    <script>
        ...
        function showResult() {
            ...
            if (isWin) {
                ...
                showMessage(`🎉 WINNER! You won $${payout}!`, 'win');
            } else {
...
def create_game_file():
    """Create the slot machine game file"""
    with open('slotmachine_game.html', 'w', encoding='utf-8') as f:
        f.write(GAME_HTML)
    
    print("🎰 Game file created!")
    print("✅ slotmachine_game.html is now available")
